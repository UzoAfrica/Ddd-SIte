...
function FullstackHeroSection() {
  return (
    <div className="mx-auto max-w-screen-xl container md:px-6 px-3 mt-[89px]">
      <h1 className="text-center font-[800] mt-2 text-5xl">
        Become a High Earning
      </h1>
      <h1 className="text-center font-[800] mt-2 text-5xl">
        Full Stack Engineer
      </h1>
      <h1 className="text-center font-[800] mt-2 text-5xl">in 18 weeks +</h1>
      <p className="text-center text-4xl text-[#101828] mt-2 font-[600]">
        Get a Tech Master's in the USA by next year
      </p>
      <p className="text-center text-lg text-[#667085] w-[83%] mx-auto mt-7 font-[500]">
