...
function Decadev() {
  return (
    <div className="mx-auto container max-w-screen-xl py-[50px] md:px-8 px-3">
        <h1 className="text-center text-2xl lg:text-5xl font-bold  md:w-[75%] mx-auto">Meet some of our Decagon Alumni (<span className="text-[#34A853]">Decadevs</span>)</h1>
        ...
        <h1 className="text-center text-2xl w-[95%] md:text-5xl font-bold mt-20 md:mt-[100px] mx-auto">Where some of our  <span className="text-[#34A853]">graduates </span>work</h1>
