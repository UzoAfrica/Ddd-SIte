...
function Training() {
  ...
  return (
    <div
      id="training"
      className="embla py-[50px] mx-auto max-w-screen-xl md:px-8 mt-8 lg:mt-[100px] px-3"
    >
      ...
      <div className="embla__viewport h-full mt-10 hidden" ref={emblaRef}>
      ...
      {/* <div className="embla__dots gap-2 mt-6  hidden">
      ...
      <div className="grid md:grid-cols-2 max-w-screen-lg mx-auto gap-10">
        <div className="border-[1px]  border-[rgba(0, 0, 0, 0.08)] custom-shadow rounded-b-md">
          ...
          <div className="px-6">
            ...
            <h1 className=" pt-3 text-lg text-[#757575] ">
              <span className="font-[700] text-black">Duration:</span> 18 Weeks
            </h1>
            <h1 className=" pt-2 text-lg">
              <span className="font-[700]">Mode of Delivery:</span>
            </h1>
        ...
        <div className="border-[2px]  border-[rgba(0, 0, 0, 0.08)] custom-shadow rounded-b-md">
          <div className="bg-image-frontend h-[170px] pl-6 pt-[42px] pb-[45px]">
            <h1 className="text-white font-[700] text-2xl">
              Frontend Development
            </h1>
          ...
          <div className="px-6">
            ...
            <h1 className=" pt-3 text-lg text-[#757575] ">
              <span className="font-[700] text-black">Duration:</span> 12 Weeks
            </h1>
            <h1 className=" pt-2 text-lg">
              <span className="font-[700]">Mode of Delivery:</span>
            </h1>
        ...
        <div className="border-[1px]  border-[rgba(0, 0, 0, 0.08)] custom-shadow rounded-b-md">
          <div className="bg-data-analysis h-[170px] pl-6 pt-[42px] pb-[45px]">
            <h1 className="text-white font-[700] text-2xl">Data Analysis</h1>
            <p className="text-white text-sm font-[700]">(with Python & SQL)</p>
          </div>
          <div className="px-6">
            <h1 className="text-center font-[500] mt-5">
              Starting at{" "}
            ...
            <h1 className=" pt-3 text-lg text-[#757575] ">
              <span className="font-[700] text-black">Duration:</span> 10 Weeks
            </h1>
            <h1 className=" pt-2 text-lg">
              <span className="font-[700]">Mode of Delivery:</span>
            </h1>
        ...
        <div className="border-[1px]  border-[rgba(0, 0, 0, 0.08)] custom-shadow rounded-b-md">
          <div className="bg-image-devops h-[170px] pl-6 pt-[42px] pb-[45px]">
            ...
            <p className="text-white text-sm font-[700]"></p>
          </div>
          <div className="px-6">
            <h1 className="text-center font-[500] mt-5">
              Starting at{" "}
