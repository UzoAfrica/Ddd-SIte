...
function FrontendHero() {
  return (
    <div className="mx-auto container max-w-screen-xlmd:px-8  py-5 lg:py-[50px] px-3">
      <div className="relative pt-24 pb-10">
        <h1 className="text-center text-6xl font-[800] py-1">
          Become a Competent
        </h1>
        <h1 className="text-center text-6xl font-[800] py-1">
          {" "}
        ...
        <Image className="absolute left-[10%] top-10"  src={Frontend_Two} alt="Image" />
        <Image className="absolute bottom-[20%] left-[7%]" src={Frontend_One} alt="Image" />
        <Image className="absolute right-[10%] bottom-[23%]"  src={Frontend_Three} alt="Image" />
        <Image className="absolute right-[20%] top-2"  src={Frontend_Four} alt="Image" />
      </div>
      <div className="max-w-screen-lg mx-auto pb-10">
        <Image className=""  src={Frontend_Hero} alt="Image" />
